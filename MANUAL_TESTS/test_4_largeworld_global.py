#!/usr/bin/env python3
"""
Manual Test 4: Large World Global Unified Target Selection Test

This test validates unified target selection behavior in a large, sparse world
with few agents that must make long-distance decisions across vast spaces.

Configuration:
- Grid: 60x60
- Agents: 15 with random positions and mixed preferences
- Resource density: 0.05 (very sparse)
- Perception radius: 25 (global awareness)
...
class Test4Window(QWidget):
    """Test window with pygame viewport for observing the simulation."""
    
    def __init__(self):
        super().__init__()
        self.simulation = None
        self.ext_rng = random.Random(1001)
        self.current_turn = 0
        self.phase = 1
        
        # Set up UI
        self.setWindowTitle("Manual Test 4: Large World Global - Unified Target Selection")
        ...
        # Status labels
        control_layout.addWidget(QLabel("Manual Test 4: Large World Global"))
        ...
        print("Test 4 Window created. Configuration:")
        print("- Grid: 60x60 (large world)")
        print("- Agents: 15 with mixed preferences") 
        print("- Resource density: 0.05 (very sparse)")
        print("- Perception radius: 25 (global awareness)")
    ...
    def start_test(self):
        ...
        try:
            ...
            # Create simulation config - large sparse world
            grid_w, grid_h = 60, 60
            resource_count = int(grid_w * grid_h * 0.05)  # 0.05 density = very sparse
            
            # Generate resources (spread throughout large world)
            resource_rng = random.Random(22222)
            resources = []
            ...
            config = SimConfig(
                ...
                enable_respawn=True,
                enable_metrics=True,
                perception_radius=25,  # Global awareness
                respawn_target_density=0.05,
                respawn_rate=0.1,  # Slower respawn for sparse world
            ...
            agent_positions = []
            pos_rng = random.Random(33333)
            positions = set()
            while len(positions) < 15:  # Only 15 agents in 60x60 grid = very sparse
            ...
            print("🎮 Watch the pygame viewport to observe global decision-making!")
            print("💡 Large world + global perception = long-distance movement patterns")
    ...
    def simulation_step(self):
        ...
        # Print progress every 100 turns (sparse world, less frequent updates)
        ...
        if self.current_turn >= 900:
            ...
            print("Large world global behavior validated. Check observations above.")
            print("=" * 60)
    ...
    def check_phase_transition(self):
        ...
        if self.current_turn == 201 and self.phase == 1:
            ...
            print("   Expected: Long-distance resource seeking across 60x60 world")
            ...
            print("   Expected: Global partner finding, long-distance meeting points")
            ...
            print("   Expected: Sparse agents return to widely distributed homes")
            ...
            print("   Expected: Resume global unified selection decisions")
...
def main():
    """Run the large world global test."""
    app = QApplication(sys.argv)
    
    test_window = Test4Window()
    test_window.show()
    
    print("=" * 60)
    print("MANUAL TEST 4: LARGE WORLD GLOBAL UNIFIED TARGET SELECTION")
    print("=" * 60)
    ...
    print("Watch the pygame viewport AND console output for global behavior.")
    print("Focus: Long-distance decisions, global optimization, sparse interactions")
    print("=" * 60)
